...
exports.SalesEnquiriesController = void 0;
const common_1 = require("@nestjs/common");
const sales_enquiries_service_1 = require("./sales-enquiries.service");
let SalesEnquiriesController = class SalesEnquiriesController {
    salesEnquiriesService;
    constructor(salesEnquiriesService) {
        this.salesEnquiriesService = salesEnquiriesService;
    }
    create(payload) {
...
], SalesEnquiriesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
], SalesEnquiriesController);
//# sourceMappingURL=sales-enquiries.controller.js.map