...
exports.CabCitiesModule = CabCitiesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([cab_city_entity_1.CabCity])],
        providers: [cab_cities_service_1.CabCitiesService],
        controllers: [cab_cities_controller_1.CabCitiesController],
        exports: [cab_cities_service_1.CabCitiesService],
    })
], CabCitiesModule);
